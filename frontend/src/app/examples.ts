    ...
    files: [
      {
        ...
        url: new URL('../../../fixtures/test-inputs/colabfold/toy_ranked_0.pdb', import.meta.url).href,
      },
      {
        name: 'toy_scores.json',
        url: new URL('../../../fixtures/test-inputs/colabfold/toy_scores.json', import.meta.url).href,
      },
    ],
  },
  {
    ...
    files: [
      {
        name: 'toy_model.cif',
        url: new URL('../../../fixtures/test-inputs/af3/toy_model.cif', import.meta.url).href,
      },
      {
        name: 'toy_confidences.json',
        url: new URL('../../../fixtures/test-inputs/af3/toy_confidences.json', import.meta.url).href,
      },
      {
        name: 'toy_summary_confidences.json',
        url: new URL('../../../fixtures/test-inputs/af3/toy_summary_confidences.json', import.meta.url).href,
      },
    ],
  },
];
