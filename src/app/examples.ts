    ...
    files: [
      {
        ...
        url: new URL('../../example/AF-O15552-F1-model_v6.pdb', import.meta.url).href,
      },
      {
        name: 'AF-O15552-F1-predicted_aligned_error_v6.json',
        url: new URL('../../example/AF-O15552-F1-predicted_aligned_error_v6.json', import.meta.url).href,
      },
    ],
  },
  {
    ...
    files: [
      {
        ...
        url: new URL('../../example/AF-0000000066503175-model_v1.pdb', import.meta.url).href,
      },
      {
        name: 'AF-0000000066503175-predicted_aligned_error_v1.json',
        url: new URL('../../example/AF-0000000066503175-predicted_aligned_error_v1.json', import.meta.url).href,
      },
    ],
  },
  {
    ...
    files: [
      {
        ...
        url: new URL('../../example/5_MDM2-A-binder_l16_s253144_mpnn1_model1.pdb', import.meta.url).href,
      },
    ],
  },
  {
